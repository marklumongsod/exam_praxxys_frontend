    ...
    data() {
        return {
            activityLog: [
                ...
                { title: 'Imperdiet', amount: 3433, icon: 'mdi-account-group-outline', color: 'green darken-2' },
                { title: 'Imperdiet', amount: 3433, icon: 'mdi-account-group-outline', color: 'blue-grey darken-1' },
                { title: 'Imperdiet', amount: 3433, icon: 'mdi-account-group-outline', color: 'deep-orange darken-1'},
            ],
            headers: [
                {
